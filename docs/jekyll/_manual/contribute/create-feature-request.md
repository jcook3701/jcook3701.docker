...
Feature requests help us understand what you need from docker. This document guides you through writing effective feature requests that help maintainers understand your needs and prioritize improvements.
...
- Search [existing feature requests](https://github.com/jcook3701/jcook3701.docker/issues?q=is%3Aissue+is%3Aopen+label%3Atype%2Ffeature-request) to see if someone already suggested something similar.

## Your first feature request

When you're ready to submit a feature request, use the [feature request template](https://github.com/jcook3701/jcook3701.docker/issues/new?template=02-feature-request.yml). The template has three sections that help maintainers understand what you need and why.

<!-- TODO: Put together an example feature request.

Here's an [example of how all three sections work together in an actual feature request](https://github.com/jcook3701/jcook3701.docker) from the docker community. We'll analyze each section based on this example feature request. -->
...
We welcome community contributions and appreciate your help making docker better!
